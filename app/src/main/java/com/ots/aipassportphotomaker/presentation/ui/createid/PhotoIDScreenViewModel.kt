...
class PhotoIDScreenViewModel @Inject constructor(
    ...
    private val _uiState: MutableStateFlow<PhotoIDScreenUiState> = MutableStateFlow(
        PhotoIDScreenUiState()
    )
    ...
    fun onItemClick(name: String) =
        _navigationState.tryEmit(PhotoIDScreenNavigationState.PhotoIDDetails(name))
