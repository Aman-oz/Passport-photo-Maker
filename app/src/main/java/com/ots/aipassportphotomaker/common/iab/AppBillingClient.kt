package com.ots.aipassportphotomaker.common.iab
...
import com.ots.aipassportphotomaker.common.iab.interfaces.QueryResponse
import com.ots.aipassportphotomaker.common.iab.onetime.OneTimePurchaseItem
import com.ots.aipassportphotomaker.common.iab.subscription.SubscribedItem
import com.ots.aipassportphotomaker.common.iab.subscription.SubscriptionItem

/**
 * Created by Aman Ullah on 19 September 2025
...
class AppBillingClient {
    ...
    companion object{
        // items for two plans(weekly and monthly)
        var SKU_ITEM_ONE_WEEK = "item_weekly"
        var SKU_ITEM_ONE_MONTH = "item_monthly"
    }
        ...
        val productList =
            listOf(
                QueryProductDetailsParams.Product.newBuilder()
                    .setProductId(SKU_ITEM_ONE_WEEK)
                    .setProductType(BillingClient.ProductType.SUBS)
                    .build(),
                QueryProductDetailsParams.Product.newBuilder()
                    .setProductId(SKU_ITEM_ONE_MONTH)
                    .setProductType(BillingClient.ProductType.SUBS)
                    .build()
            )
